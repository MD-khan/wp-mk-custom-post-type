<form id="mk-contact-form" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
	...
	<div class="text-center">
     ...
     <input type="hidden" name="nonce" value="<?=wp_create_nonce("mk_cf_contact_form_nonce")?>">
</form>